...
// number of particles on on scroll set karo jese ki hum scrool don kare size chota ho jaye
let value = "#fcfcfc";
  ...
  const options = useMemo(() => {
    ...
    return {
      ...
      interactivity: {
        events: {
          ...
          onHover: {
            ...
            mode: "repulse",
            size : {min:1}, // make the particles run away from the cursor
          },
        },
        modes: {
          push: {
      ...
      particles: {
        ...
        size: {
          value: { min: 1, max: 100 }, // let's randomize the particles size a bit
        },
        shape:{
          type:"circle",
        },
