    ...
    return(
        <>        <div className="project-wrapper lg:w-1/2 rounded-4xl p-4 my-4 mx-auto mt-24 ">
            <div className="content mb-24">
             <div className="title font-bold text-xl lg:text-4xl "><span className='grade '> Yeah,I really work hard </span><small>💼</small></div>
             <div className="project-content mb-8  lg:text-3xl">Each of my project is Unique ✨</div>
             </div>
